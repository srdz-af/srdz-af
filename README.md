...
### [polyple - polyple.xyz](https://polyple.xyz)

Web-based N-dimensional geometry viewer and editor.

A recurrent childhood question of mine was what higher-dimensional shapes looked like, polyple is a full client-side editor for visualizing these kinds of geometries with blender-like controls and a lot of materials and scene configurations.
Working on expanding the primitives library.
